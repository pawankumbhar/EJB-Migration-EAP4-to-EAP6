...
public class LoginAction extends Action {
	...
	//	EAP5
        Context ejbCtx = (Context) lContext.lookup("java:comp/env");

	//	LoginVerifierHome lHome = (LoginVerifierHome) lContext.lookup("LoginVerifierBean");
        
    		LoginVerifierHome lHome = (LoginVerifierHome) ejbCtx.lookup("LoginVerifierBean");

		
	//	login bean=(login) lContext.lookup("java:global/libra6EJB/LoginVerifierBean!business.ejb.login.login");
